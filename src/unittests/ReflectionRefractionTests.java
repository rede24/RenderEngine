...
//						new Ray(new Point3D(0, 0, 0), new Vector(1, 0, 0))),
				...
				new Triangle(new Color(40, 40, 40), new Material(0.5, 0.5, 60, 0.8, 0), //
		...
		ImageWriter imageWriter = new ImageWriter("bonus_image", 200, 200, 1000, 1000);
		Render render = new Render(imageWriter, scene).setDebugPrint().setBox(4);
		render.renderImage();
		render.writeToImage();
	}
	...
	public void bonusTestDiffAngle() {
		...
		ImageWriter imageWriter = new ImageWriter("bonus_image01", 200, 200, 600, 600);
		Render render = new Render(imageWriter, scene);
		render.renderImage();
		render.writeToImage();
	}
